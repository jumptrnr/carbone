...
var builder = {
            ...
            parser.preprocessMarkers(
              ...
              function (err, preprocessedMarkers) {
                ...
                try {
                  ...
                  _builder(_obj, options, helper, _builder.builderDictionary)
                    .then((parts) => {
                      _xmlParts = parts;
  ...
  getFormatterString: function (
    ...
    console.log("getFormatterString");
    var _lineOfCodes = [];
  ...
  getBuilderFunction: function (descriptor, existingFormatters) {
    ...
    try {
      ...
      throw new Error(
        "getSubstitutionFunction: Impossible to generate the XML builder.\n" +
          err +
          "\n--------------------------------\n" +
          _codeAssembled +
          "\n--------------------------------\n"
