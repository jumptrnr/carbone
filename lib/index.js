...
// Log all initial requires to see if any of them might cause the dyld error
try {
  debug("Loading required modules...");

  debug("Loading fs module...");
  var fs = require("fs");

  debug("Loading os module...");
  var os = require("os");

  debug("Loading path module...");
  var path = require("path");

  debug("Loading internal modules...");
  debug("Loading ./file...");
  ...
  debug("Loading ./postprocessor...");
  var postprocessor = require("./postprocessor");

  debug("Loading ./translator...");
  var translator = require("./translator");

  debug("Loading ./converter...");
  var converter = require("./converter");

  debug("Loading dayjs...");
  var dayjs = require("dayjs");

  debug("Loading formatters/_locale...");
