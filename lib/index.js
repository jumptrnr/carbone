...
try {
  ...
  console.log("Loading debug module for Carbone...");
  var debug = require("debug")("carbone");
  debug("Initializing Carbone module");

  console.log("Loading dayjs module...");
  var dayjs = require("dayjs");

  console.log("Loading locales module...");
...
console.log("Step 1: Checking if all core modules are accessible...");
console.log("fs:", !!fs, "os:", !!os, "path:", !!path);

console.log("Step 2: Checking if all local modules are accessible...");
console.log("file:", !!file, "params:", !!params, "helper:", !!helper);

console.log("Step 3: Checking dayjs...");
console.log("dayjs object:", !!dayjs);

console.log("Step 4: Checking locales...");
console.log("locales object:", !!locales);

console.log("Carbone module loaded successfully - now setting up...");
console.log("About to define carbone object...");
...
function convert(inputFileBuffer, customReportName, options, callback) {
  ...
  fs.writeFile(_intermediateFile, inputFileBuffer, function (err) {
    ...
    converter.convertFile(
      ...
      _renderFile,
      function (errConvert, outputFile) {
