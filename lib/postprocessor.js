  ...
  process: function (template, _data, _options, callback) {
    ...
    switch (template.extension) {
      case "odt":
        ...
        console.log("odt postprocessor created");
        break;
      case "docx":
        processor = new DocxPostProcessor(template);
        console.log("docx postprocessor created");
        break;
      case "html":
        processor = new HtmlPostProcessor(template);
        console.log("html postprocessor created");
        break;
      case "xlsx":
        console.log("xlsx postprocessor created");
      case "ods":
        console.log("xlsx or ods postprocessor created");
        return callback();
        return callback();
      case "odp":
        processor = new OdpPostProcessor(template);
        console.log("odp postprocessor created");
        break;
    }
...
function fetchImages(urls) {
  ...
  console.log(`Preparing to fetch ${urls.length} images:`);
